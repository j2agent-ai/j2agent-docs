...
[`EmbeddingService`](../../j2agent/j2agent-server/src/main/java/io/github/jerryt92/j2agent/service/embedding/EmbeddingService.java) 对任意 embed 请求的单条 input 也会按 `max-embedding-input-chars` 防御截断，避免管理端直连 Embedding API 仍返回 400。

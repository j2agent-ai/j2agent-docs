...
Schema：新建库 `sql/schema/mysql/V0_0__schemas.sql`；已有库迁移 `sql/migration/mysql/20260511_chat_memory_agent_id.sql`。
...
| 助手 Agent 装配示例 | `j2agent-plugins-agents/agents/j2agent-qa-assistant/.../AssistantReactAgent.java` |

...
当前渲染器版本：`MARKDOWN_RENDERER_REVISION = '28'`（[`markdownRenderer.ts`](../../../j2agent-ui/src/utils/markdownRenderer.ts)）。
...
| 常量 | 值 | 含义 |
|------|-----|------|
| `MARKDOWN_RENDERER_REVISION` | `'28'` | HTML/块 revision，与 Vue `:key` 同步 |
